          ...
          <div className='info-container'>
            {selectedUser !== null ? (
              <ul className='list-unstyled'>
                <li className='mb-75'>
                  <span className='fw-bolder me-25'>Product Name:</span>
                  <span>{selectedUser.username}</span>
                </li>
                <li className='mb-75'>
                  <span className='fw-bolder me-25'>Created On:</span>
                ...
                <li className='mb-75'>
                  <span className='fw-bolder me-25'>Country of Origin:</span>
                  <span>Tax-{selectedUser.contact.substr(selectedUser.contact.length - 4)}</span>
                </li>
                <li className='mb-75'>
                  <span className='fw-bolder me-25'>MRP:</span>
                ...
                <li className='mb-75'>
                  <span className='fw-bolder me-25'>Sub Category:</span>
                  <span>England</span>
                </li>
              </ul>
            ) : null}
